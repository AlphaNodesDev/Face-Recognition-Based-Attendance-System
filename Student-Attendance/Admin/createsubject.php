...
if(isset($_POST['save'])){
    ...
    if($ret > 0){ 
        ...
        $query=mysqli_query($conn,"insert into tblsubjects(subjectname) value('$subjectname')");
 ...
 if (isset($_GET['Id']) && isset($_GET['action']) && $_GET['action'] == "edit")
	{
        ...
        if(isset($_POST['update'])){
            ...
            $query=mysqli_query($conn,"update tblsubjects set subjectname='$subjectname' where Id='$Id'");
                ...
                <div class="card-body">
                  <form method="post">
                    <div class="form-group row mb-3">
                      ...
                      <input type="text" class="form-control" name="subjectname" value="<?php echo $row['subjectname'];?>" id="subjectname" placeholder="Class Name">
                        </div>
                    </div>
                      <?php
                    if (isset($Id))
