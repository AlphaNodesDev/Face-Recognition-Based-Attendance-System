...
if(isset($_POST['save'])){
  ...
  $dateCreated = date("Y-m-d");
    ...
    $query=mysqli_query($conn,"INSERT into tblteachers(firstName,lastName,emailAddress,password,phoneNo,classId,classArmId,dateCreated,subject) 
    value('$firstName','$lastName','$emailAddress','$sampPass_2','$phoneNo','$classId','$classArmId','$dateCreated','$subjectname')");
                  ...
                  <form method="post">
                   <div class="form-group row mb-3">
                     ...
                     <div class="form-group row mb-3">
                        ...
                        $num = $result->num_rows;		
                        if ($num > 0){
                          echo ' <select required name="subjectname" onchange="subjectDropdown(this.value)" class="form-control mb-3">';
                          echo'<option value="">--Select Class--</option>';
                          while ($rows = $result->fetch_assoc()){
                          echo'<option value="'.$rows['subjectname'].'" >'.$rows['subjectname'].'</option>';
                              }
                                  echo '</select>';
                              }
                            ?>  
